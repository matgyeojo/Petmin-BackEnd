...
public class PetProfileController {
	...
	public ResponseEntity<String> petprofileSave(@RequestParam String userId, @RequestParam String petName,
	...
	// 가장 최근 등록한 펫번호 찾기
	@GetMapping("/petRecenNum/{user}")
	public Integer getLatestPetNoByUserId(@PathVariable Users user) {
		return PetProfileService.LatestPetNoByUserId(user);
	}
}
