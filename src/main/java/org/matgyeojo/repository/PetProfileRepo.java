...
//	public List<PetProfile> findByPetSexAndPetWeightGreaterThan(String petSex, double petWeight);
	...
	public List<String> findjoong(int userAge, String userSex, String userAddress, String sitterHousetype,
			String petSex, int petWeight);
	...
	// 가장 최근에 등록한 펫정보 찾는거
	public PetProfile findFirstByUserIdOrderByPetNoDesc(Users user);
