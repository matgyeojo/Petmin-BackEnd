...
public class PetProfileService {
	...
	public String petprofileSave(String userId, String petName, int petAge, String petSpecies, double petWeight,
			String petSex, MultipartFile petImg, String petMsg) throws IOException {
	...
	public Integer LatestPetNoByUserId(Users user) {
		...
		return null; // 해당 userId에 해당하는 PetProfile이 없는 경우
	}
